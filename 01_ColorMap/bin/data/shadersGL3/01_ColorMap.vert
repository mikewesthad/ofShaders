...
void main(){
    ...
    // gl_Position is a built-in output from the vertex shasder to the next stage, vertex post-processing.
    //  Post-processing does things like checking if vetrices are within view of the camera
    //  See http://www.opengl.org/wiki/Vertex_Post-Processing
    // Here we are performing a standard shader operation:
    //  Matrix multiplication to take a position in object space and projecting it onto the camera's screen
